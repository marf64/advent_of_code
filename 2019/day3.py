...
def lay_straight_path(start, direction, distance, points, value):
	loc = start
...
def lay_wire(wire, points, value):
	loc = (0,0)
	for d in wire:
		direction = get_direction(d)
		distance = int(d[1:])
		points, loc = lay_straight_path(loc, direction, distance, points, value)
	return points
...
points = lay_wire(wire1, points, 2)
points = lay_wire(wire2, points, 3)
